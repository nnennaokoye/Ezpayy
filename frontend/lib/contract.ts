...
export const EZPAY_CONTRACT_ADDRESS = "0xc0C6F54f2256D2ED46aBdB84053Fa0cF549Bb8a4" as const;
...
export const EZPAY_ABI = [
  ...
  { "type": "function", "name": "payBillWithAuthorization", "inputs": [
      { "name": "authorization", "type": "tuple", "internalType": "struct Ezpay.Authorization", "components": [
  ...
  { "type": "function", "name": "getBill", "inputs": [ { "name": "billId", "type": "bytes32", "internalType": "bytes32" } ], "outputs": [ { "name": "", "type": "tuple", "internalType": "struct Ezpay.Bill", "components": [
      { "name": "receiver", "type": "address", "internalType": "address" },
      { "name": "token", "type": "address", "internalType": "address" },
      { "name": "amount", "type": "uint256", "internalType": "uint256" },
      { "name": "paid", "type": "bool", "internalType": "bool" },
