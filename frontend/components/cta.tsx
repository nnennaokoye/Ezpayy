      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            Join thousands of merchants and customers already using EzPay for seamless, gasless crypto payments on
            Mantle network.
          </p>
        ...
        <Card className="bg-gradient-to-r from-primary to-secondary text-white animate-slide-up">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            Whether you're a business ready to accept crypto payments or a customer wanting seamless transactions, EzPay makes it simple and gasless.
            </p>
          </CardContent>
        </Card>
      </div>
