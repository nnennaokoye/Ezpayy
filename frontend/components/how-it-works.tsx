...
const steps = [
  ...
  },
  {
    ...
    description: "EzPay sponsors gas fees and settles the payment instantly on Mantle network",
    step: "03",
  },
]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-slide-up">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            How <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">EzPay</span>{" "}
            Works
          </h2>
